...
export const Home = () => {
  return (
    <>
      ...
      {/* Eco */}
      <section>
        <div className='w-[1400px] relative flex'>
          <div>
            <img className='w-[903px] h-[951px]' src={eco_bg} alt="img" />
          </div>
          <div className='container w-[700px] absolute left-[751px] mt-[140px] py-[78px] px-[89px] rounded-3xl bg-white'>
      ...
      <section>
        <div className='py-[187px] bg-about_bg'>
          <ul className='flex mx-auto gap-6 w-[1500px]'>
            {foodsData.map((item) =>
